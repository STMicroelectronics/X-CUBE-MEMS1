...
## <b>GyroscopeCalibration Application Description</b>

This application shows how to use [MotionGC - Gyroscope Calibration](https://www.st.com/resource/en/user_manual/um2181-getting-started-with-motiongc-gyroscope-calibration-library-in-xcubemems1-expansion-for-stm32cube-stmicroelectronics.pdf) library to correct gyroscope sensor data by using gyroscope and accelerometer sensors.
...
After connection has been established:
  ...
  - the user can view gyroscope calibration data and compensated values
