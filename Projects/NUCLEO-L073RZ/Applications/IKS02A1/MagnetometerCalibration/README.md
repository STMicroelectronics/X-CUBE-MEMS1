...
## <b>MagnetometerCalibration Application Description</b>

This application shows how to use [MotionMC - Magnetometer Calibration](https://www.st.com/resource/en/user_manual/um2192-getting-started-with-motionmc-magnetometer-calibration-library-in-xcubemems1-expansion-for-stm32cube-stmicroelectronics.pdf) library to correct magnetometer sensor data by using magnetometer only.
...
After connection has been established:
  ...
  - the user can view magnetometer calibration data and compensated values
