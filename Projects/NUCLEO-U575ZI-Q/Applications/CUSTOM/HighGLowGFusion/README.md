...
This application shows how to use [MotionXLF - High-g Low-g Fusion](https://www.st.com) library to fuse the accelerometer sensor data using high-g sensors such as LSM6DSV320X only.
