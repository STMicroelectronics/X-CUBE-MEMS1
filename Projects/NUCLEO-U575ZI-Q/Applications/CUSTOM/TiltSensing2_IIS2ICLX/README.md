...
This application shows how to use 2-axis Tilt Sensing library to get the tilt angles and shows how to use 2-axis Accelerometer Calibration library to correct accelerometer sensor data using IIS2ICLX 2-axis accelerometer only.
