...
static void MX_FitnessActivities_Init(void);
static void MX_FitnessActivities_Process(void);
...
static void MX_FitnessActivities_Init(void)
{
  ...
  /* OPTIONAL */
  /* Get library version */
  MotionFA_manager_get_version(LibVersion, &LibVersionLen);
  ...
  if ((SensorsEnabled & ACCELEROMETER_SENSOR) == ACCELEROMETER_SENSOR)
  {
    if ((SensorsEnabled & GYROSCOPE_SENSOR) == GYROSCOPE_SENSOR)
    {
      if ((SensorsEnabled & PRESSURE_SENSOR) == PRESSURE_SENSOR)
      {
        ...
        data_in.GyrX = (float)GyrValue.x / 1000.0f;    /* Convert from [mdps] to [dps] */
        data_in.GyrY = (float)GyrValue.y / 1000.0f;    /* Convert from [mdps] to [dps] */
        data_in.GyrZ = (float)GyrValue.z / 1000.0f;    /* Convert from [mdps] to [dps] */
