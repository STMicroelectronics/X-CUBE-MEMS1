...
static void MX_PoseEstimation_Init(void);
static void MX_PoseEstimation_Process(void);
...
static void MX_PoseEstimation_Init(void)
{
  ...
  /* PoseEstimation API initialization function */
  MotionPE_manager_init();

  /* OPTIONAL */
  /* Get library version */
  MotionPE_manager_get_version(LibVersion, &LibVersionLen);
