...
static void MX_ActivityRecognitionWrist_Init(void);
static void MX_ActivityRecognitionWrist_Process(void);
...
void MX_MEMS_Init(void)
{
  ...
  MX_ActivityRecognitionWrist_Init();
...
void MX_MEMS_Process(void)
{
  ...
  MX_ActivityRecognitionWrist_Process();
...
static void MX_ActivityRecognitionWrist_Init(void)
{
  ...
  /* OPTIONAL */
  /* Get library version */
  MotionAW_manager_get_version(LibVersion, &LibVersionLen);
...
static void MX_ActivityRecognitionWrist_Process(void)
{
  ...
  if (SensorReadRequest == 1U)
  {
    ...
    /* Activity Recognition Wrist specific part */
...
static void AW_Data_Handler(TMsg *Msg)
{
  ...
  if ((SensorsEnabled & ACCELEROMETER_SENSOR) == ACCELEROMETER_SENSOR)
  {
    ...
    /* Run Activity Recognition Wrist algorithm */
    BSP_LED_On(LED2);
    DWT_Start();
    MotionAW_manager_run(&data_in, &data_out, Timestamp);
    elapsed_time_us = DWT_Stop();
    BSP_LED_Off(LED2);

    Timestamp += (int64_t)ReportInterval;

    Serialize_s32(&Msg->Data[55], (int32_t)data_out.current_activity, 4);
