...
## <b>TiltSensing Application Description</b>

This application shows how to use [MotionTL - Tilt Sensing](https://www.st.com/resource/en/user_manual/um2277-getting-started-with-motiontl-tilt-measurement-library-in-xcubemems1-expansion-for-stm32cube-stmicroelectronics.pdf) library to get the tilt angles and 6-position calibration by using accelerometer only.
...
After connection has been established:
  ...
  - the user can view tilt sensing data
  - the user can perform calibration and view calibration parameters
...
ADDITIONAL_BOARD : X-NUCLEO-IKS02A1 https://www.st.com/en/evaluation-tools/x-nucleo-iks02a1.html
