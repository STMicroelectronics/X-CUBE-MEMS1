...
This application shows how to use [MotionDI - Dynamic Inclinometer](https://www.st.com/resource/en/user_manual/um2724-getting-started-with-motiondi-dynamic-inclinometer-library-in-xcubemems1-expansion-for-stm32cube-stmicroelectronics.pdf) library to estimate current inclination by using accelerometer and gyroscope sensor.
