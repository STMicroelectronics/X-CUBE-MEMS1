...
## <b>GestureRecognition Application Description</b>

This application shows how to use [MotionGR - Gesture Recognition](https://www.st.com/resource/en/user_manual/um2201-getting-started-with-motiongr-realtime-gesture-recognition-library-in-xcubemems1-expansion-for-stm32cube-stmicroelectronics.pdf) library to estimate current user gesture by using accelerometer only.
...
After connection has been established:
  ...
  - the user can view gesture recognition data
