...
This application shows how to use [MotionPE - Pose Estimation](https://www.st.com/resource/en/user_manual/um2223-getting-started-with-motionpe-realtime-pose-estimation-library-in-xcubemems1-expansion-for-stm32cube-stmicroelectronics.pdf) library to estimate current user pose by using accelerometer only.
