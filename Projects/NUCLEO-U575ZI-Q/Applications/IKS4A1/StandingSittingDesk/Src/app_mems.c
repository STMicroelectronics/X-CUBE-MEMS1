...
static void MX_StandingSittingDesk_Init(void);
static void MX_StandingSittingDesk_Process(void);
static void SD_Data_Handler(Msg_t *Msg);
...
void MX_MEMS_Process(void)
{
  ...
  MX_StandingSittingDesk_Process();
...
static void MX_StandingSittingDesk_Init(void)
{
  ...
  /* StandingSittingDesk API initialization function */
  MotionSD_manager_init();

  /* OPTIONAL */
  /* Get library version */
  MotionSD_manager_get_version(LibVersion, &LibVersionLen);
...
static void MX_StandingSittingDesk_Process(void)
{
  ...
  if (SensorReadRequest == 1U)
  {
    ...
    /* StandingSittingDesk specific part */
...
/**
  ...
  * @param  Msg the Standing Sitting Desk data part of the stream
  * @retval None
  */
static void SD_Data_Handler(Msg_t *Msg)
{
  ...
  if ((SensorsEnabled & ACCELEROMETER_SENSOR) == ACCELEROMETER_SENSOR)
  {
    if ((SensorsEnabled & PRESSURE_SENSOR) == PRESSURE_SENSOR)
    {
      ...
      /* Run Standing Sitting Desk algorithm */
      BSP_LED_On(LED2);
      DWT_Start();
