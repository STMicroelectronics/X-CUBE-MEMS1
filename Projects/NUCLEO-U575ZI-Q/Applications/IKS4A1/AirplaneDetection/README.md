...
## <b>AirplaneDetection Application Description</b>

This application shows how to use [MotionAD - Airplane Detection](https://www.st.com/resource/en/user_manual/um2722-getting-started-with-motionad-airplane-detection-library-in-xcubemems1-expansion-for-stm32cube-stmicroelectronics.pdf) library to estimate current Airplane mode by using accelerometer, pressure and temperature sensor.
...
After connection has been established:
  ...
  - the user can view airplane detection data
