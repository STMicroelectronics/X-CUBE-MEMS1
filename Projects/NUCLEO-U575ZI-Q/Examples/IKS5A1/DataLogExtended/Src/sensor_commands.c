...
{
  {5, 250, 500, 1000, 2000, 4000},      /* ISM6HG256X */
  {5, 125, 250, 500, 1000, 2000},       /* ISM330IS */
...
{
  {12, 1.875, 7.5, 15, 30, 60, 120, 240, 480, 960, 1920, 3840, 7680}, /* ISM6HG256X */
  {11, 1.6, 12.5, 26, 52, 104, 208, 416, 833, 1667, 3333, 6667},      /* ISM330IS */
...
{
  {11, 7.5, 15, 30, 60, 120, 240, 480, 960, 1920, 3840, 7680},        /* ISM6HG256X */
  {10, 12.5, 26, 52, 104, 208, 416, 833, 1667, 3333, 6667},           /* ISM330IS */
...
static void JoinNames(uint8_t NamesString[], uint8_t NamesList[][SENSOR_NAME_MAX_LENGTH], uint8_t NamesCount);
...
static int32_t SC_Read_Register(Msg_t *Msg)
{
  ...
  {
    case SC_ACCELEROMETER:
      if (IKS5A1_MOTION_SENSOR_Read_Register(AccInstance, Msg->Data[5], &reg_value) != BSP_ERROR_NONE)
      {
        return 0;
      }
      break;
    ...
    case SC_GYROSCOPE:
      if (IKS5A1_MOTION_SENSOR_Read_Register(GyrInstance, Msg->Data[5], &reg_value) != BSP_ERROR_NONE)
      {
        return 0;
      }
      break;
    ...
    case SC_MAGNETOMETER:
      if (IKS5A1_MOTION_SENSOR_Read_Register(MagInstance, Msg->Data[5], &reg_value) != BSP_ERROR_NONE)
      {
        return 0;
      }
      break;
    ...
    case SC_TEMPERATURE:
      if (IKS5A1_ENV_SENSOR_Read_Register(TmpInstance, Msg->Data[5], &reg_value) != BSP_ERROR_NONE)
      {
        return 0;
      }
      break;
    ...
    case SC_HUMIDITY:
      if (IKS5A1_ENV_SENSOR_Read_Register(HumInstance, Msg->Data[5], &reg_value) != BSP_ERROR_NONE)
      {
        return 0;
      }
      break;
    ...
    case SC_PRESSURE:
      if (IKS5A1_ENV_SENSOR_Read_Register(PrsInstance, Msg->Data[5], &reg_value) != BSP_ERROR_NONE)
      {
        return 0;
      }
      break;
...
static int32_t SC_Write_Register(Msg_t *Msg)
{
  ...
  {
    case SC_ACCELEROMETER:
      if (IKS5A1_MOTION_SENSOR_Write_Register(AccInstance, Msg->Data[5], Msg->Data[6]) != BSP_ERROR_NONE)
      {
        return 0;
      }
      break;
    ...
    case SC_GYROSCOPE:
      if (IKS5A1_MOTION_SENSOR_Write_Register(GyrInstance, Msg->Data[5], Msg->Data[6]) != BSP_ERROR_NONE)
      {
        return 0;
      }
      break;
    ...
    case SC_MAGNETOMETER:
      if (IKS5A1_MOTION_SENSOR_Write_Register(MagInstance, Msg->Data[5], Msg->Data[6]) != BSP_ERROR_NONE)
      {
        return 0;
      }
      break;
    ...
    case SC_TEMPERATURE:
      if (IKS5A1_ENV_SENSOR_Write_Register(TmpInstance, Msg->Data[5], Msg->Data[6]) != BSP_ERROR_NONE)
      {
        return 0;
      }
      break;
    ...
    case SC_HUMIDITY:
      if (IKS5A1_ENV_SENSOR_Write_Register(HumInstance, Msg->Data[5], Msg->Data[6]) != BSP_ERROR_NONE)
      {
        return 0;
      }
      break;
    ...
    case SC_PRESSURE:
      if (IKS5A1_ENV_SENSOR_Write_Register(PrsInstance, Msg->Data[5], Msg->Data[6]) != BSP_ERROR_NONE)
      {
        return 0;
      }
      break;
...
static int32_t SC_Set_Full_Scale(Msg_t *Msg)
{
  ...
  {
    case SC_ACCELEROMETER:
      if (IKS5A1_MOTION_SENSOR_SetFullScale(AccInstance, MOTION_ACCELERO, (int32_t)full_scale) != BSP_ERROR_NONE)
      {
        return 0;
      }
      break;
    ...
    case SC_GYROSCOPE:
      if (IKS5A1_MOTION_SENSOR_SetFullScale(GyrInstance, MOTION_GYRO, (int32_t)full_scale) != BSP_ERROR_NONE)
      {
        return 0;
      }
      break;
    ...
    case SC_MAGNETOMETER:
      if (IKS5A1_MOTION_SENSOR_SetFullScale(MagInstance, MOTION_MAGNETO, (int32_t)full_scale) != BSP_ERROR_NONE)
      {
        return 0;
      }
      break;
...
static int32_t SC_Get_Full_Scale(Msg_t *Msg)
{
  ...
  {
    case SC_ACCELEROMETER:
      if (IKS5A1_MOTION_SENSOR_GetFullScale(AccInstance, MOTION_ACCELERO, &full_scale) != BSP_ERROR_NONE)
      {
        return 0;
      }
      break;
    ...
    case SC_GYROSCOPE:
      if (IKS5A1_MOTION_SENSOR_GetFullScale(GyrInstance, MOTION_GYRO, &full_scale) != BSP_ERROR_NONE)
      {
        return 0;
      }
      break;
    ...
    case SC_MAGNETOMETER:
      if (IKS5A1_MOTION_SENSOR_GetFullScale(MagInstance, MOTION_MAGNETO, &full_scale) != BSP_ERROR_NONE)
      {
        return 0;
      }
      break;
...
static int32_t SC_Set_ODR(Msg_t *Msg)
{
  ...
  {
    case SC_ACCELEROMETER:
      if (IKS5A1_MOTION_SENSOR_SetOutputDataRate(AccInstance, MOTION_ACCELERO, odr) != BSP_ERROR_NONE)
      {
        return 0;
      }
      break;
    ...
    case SC_GYROSCOPE:
      if (IKS5A1_MOTION_SENSOR_SetOutputDataRate(GyrInstance, MOTION_GYRO, odr) != BSP_ERROR_NONE)
      {
        return 0;
      }
      break;
    ...
    case SC_MAGNETOMETER:
      if (IKS5A1_MOTION_SENSOR_SetOutputDataRate(MagInstance, MOTION_MAGNETO, odr) != BSP_ERROR_NONE)
      {
        return 0;
      }
      break;
    ...
    case SC_TEMPERATURE:
      if (IKS5A1_ENV_SENSOR_SetOutputDataRate(TmpInstance, ENV_TEMPERATURE, odr) != BSP_ERROR_NONE)
      {
        return 0;
      }
      break;
    ...
    case SC_HUMIDITY:
      if (IKS5A1_ENV_SENSOR_SetOutputDataRate(HumInstance, ENV_HUMIDITY, odr) != BSP_ERROR_NONE)
      {
        return 0;
      }
      break;
    ...
    case SC_PRESSURE:
      if (IKS5A1_ENV_SENSOR_SetOutputDataRate(PrsInstance, ENV_PRESSURE, odr) != BSP_ERROR_NONE)
      {
        return 0;
      }
      break;
...
static int32_t SC_Get_ODR(Msg_t *Msg)
{
  ...
  {
    case SC_ACCELEROMETER:
      if (IKS5A1_MOTION_SENSOR_GetOutputDataRate(AccInstance, MOTION_ACCELERO, &odr) != BSP_ERROR_NONE)
      {
        return 0;
      }
      break;
    ...
    case SC_GYROSCOPE:
      if (IKS5A1_MOTION_SENSOR_GetOutputDataRate(GyrInstance, MOTION_GYRO, &odr) != BSP_ERROR_NONE)
      {
        return 0;
      }
      break;
    ...
    case SC_MAGNETOMETER:
      if (IKS5A1_MOTION_SENSOR_GetOutputDataRate(MagInstance, MOTION_MAGNETO, &odr) != BSP_ERROR_NONE)
      {
        return 0;
      }
      break;
    ...
    case SC_TEMPERATURE:
      if (IKS5A1_ENV_SENSOR_GetOutputDataRate(TmpInstance, ENV_TEMPERATURE, &odr) != BSP_ERROR_NONE)
      {
        return 0;
      }
      break;
    ...
    case SC_HUMIDITY:
      if (IKS5A1_ENV_SENSOR_GetOutputDataRate(HumInstance, ENV_HUMIDITY, &odr) != BSP_ERROR_NONE)
      {
        return 0;
      }
      break;
    ...
    case SC_PRESSURE:
      if (IKS5A1_ENV_SENSOR_GetOutputDataRate(PrsInstance, ENV_PRESSURE, &odr) != BSP_ERROR_NONE)
      {
        return 0;
      }
      break;
...
static int32_t SC_Get_Sensor_List(Msg_t *Msg)
{
  ...
  if (is_initialized == 0)
  {
    JoinNames(AccNamesString, AccNameList, sizeof(AccNameList) / SENSOR_NAME_MAX_LENGTH);
    JoinNames(GyrNamesString, GyrNameList, sizeof(GyrNameList) / SENSOR_NAME_MAX_LENGTH);
    JoinNames(MagNamesString, MagNameList, sizeof(MagNameList) / SENSOR_NAME_MAX_LENGTH);
    JoinNames(TmpNamesString, TmpNameList, sizeof(TmpNameList) / SENSOR_NAME_MAX_LENGTH);
    JoinNames(HumNamesString, HumNameList, sizeof(HumNameList) / SENSOR_NAME_MAX_LENGTH);
    JoinNames(PrsNamesString, PrsNameList, sizeof(PrsNameList) / SENSOR_NAME_MAX_LENGTH);
    is_initialized = 1;
  }
  ...
  switch (Msg->Data[4])
  {
    case SC_ACCELEROMETER:
      ...
      if (AccInstance != AccInstanceList[AccIndex])
      {
        ...
        {
          if (IKS5A1_MOTION_SENSOR_Disable(AccInstance, MOTION_ACCELERO) != BSP_ERROR_NONE)
          {
            ret = 0;
          }
        }
        if (IKS5A1_MOTION_SENSOR_Init(AccInstanceList[AccIndex], MOTION_ACCELERO) != BSP_ERROR_NONE)
        {
          ret = 0;
        }
    ...
    case SC_GYROSCOPE:
      ...
      if (GyrInstance != GyrInstanceList[GyrIndex])
      {
        ...
        {
          if (IKS5A1_MOTION_SENSOR_Disable(GyrInstance, MOTION_GYRO) != BSP_ERROR_NONE)
          {
            ret = 0;
          }
        }
        if (IKS5A1_MOTION_SENSOR_Init(GyrInstanceList[GyrIndex], MOTION_GYRO) != BSP_ERROR_NONE)
        {
          ret = 0;
        }
    ...
    case SC_MAGNETOMETER:
      ...
      if (MagInstance != MagInstanceList[MagIndex])
      {
        ...
        {
          if (IKS5A1_MOTION_SENSOR_Disable(MagInstance, MOTION_MAGNETO) != BSP_ERROR_NONE)
          {
            ret = 0;
          }
        }
        if (IKS5A1_MOTION_SENSOR_Init(MagInstanceList[MagIndex], MOTION_MAGNETO) != BSP_ERROR_NONE)
        {
          ret = 0;
        }
    ...
    case SC_TEMPERATURE:
      ...
      if (TmpInstance != TmpInstanceList[TmpIndex])
      {
        ...
        {
          if (IKS5A1_ENV_SENSOR_Disable(TmpInstance, ENV_TEMPERATURE) != BSP_ERROR_NONE)
          {
            ret = 0;
          }
        }
        if (IKS5A1_ENV_SENSOR_Init(TmpInstanceList[TmpIndex], ENV_TEMPERATURE) != BSP_ERROR_NONE)
        {
          ret = 0;
        }
    ...
    case SC_HUMIDITY:
      ...
      if (HumInstance != HumInstanceList[HumIndex])
      {
        ...
        {
          if (IKS5A1_ENV_SENSOR_Disable(HumInstance, ENV_HUMIDITY) != BSP_ERROR_NONE)
          {
            ret = 0;
          }
        }
        if (IKS5A1_ENV_SENSOR_Init(HumInstanceList[HumIndex], ENV_HUMIDITY) != BSP_ERROR_NONE)
        {
          ret = 0;
        }
    ...
    case SC_PRESSURE:
      ...
      if (PrsInstance != PrsInstanceList[PrsIndex])
      {
        ...
        {
          if (IKS5A1_ENV_SENSOR_Disable(PrsInstance, ENV_PRESSURE) != BSP_ERROR_NONE)
          {
            ret = 0;
          }
        }
        if (IKS5A1_ENV_SENSOR_Init(PrsInstanceList[PrsIndex], ENV_PRESSURE) != BSP_ERROR_NONE)
        {
          ret = 0;
        }
...
static int32_t SC_Write_Multi_Register(Msg_t *Msg)
{
  ...
  switch (Msg->Data[4])
  {
    case SC_ACCELEROMETER:
      ...
      {
        if (IKS5A1_MOTION_SENSOR_Write_Register(AccInstance, Msg->Data[6U + (2U * i)],
    ...
    case SC_GYROSCOPE:
      for (i = 0; i < Msg->Data[5]; i++)
      {
        if (IKS5A1_MOTION_SENSOR_Write_Register(GyrInstance, Msg->Data[6U + (2U * i)],
                                                Msg->Data[7U + (2U * i)]) != BSP_ERROR_NONE)
        {
          ret = 0;
        }
    ...
    case SC_MAGNETOMETER:
      for (i = 0; i < Msg->Data[5]; i++)
      {
        if (IKS5A1_MOTION_SENSOR_Write_Register(MagInstance, Msg->Data[6U + (2U * i)],
                                                Msg->Data[7U + (2U * i)]) != BSP_ERROR_NONE)
        {
          ret = 0;
        }
    ...
    case SC_TEMPERATURE:
      for (i = 0; i < Msg->Data[5]; i++)
      {
        if (IKS5A1_ENV_SENSOR_Write_Register(TmpInstance, Msg->Data[6U + (2U * i)],
                                             Msg->Data[7U + (2U * i)]) != BSP_ERROR_NONE)
        {
          ret = 0;
        }
    ...
    case SC_HUMIDITY:
      for (i = 0; i < Msg->Data[5]; i++)
      {
        if (IKS5A1_ENV_SENSOR_Write_Register(HumInstance, Msg->Data[6U + (2U * i)],
                                             Msg->Data[7U + (2U * i)]) != BSP_ERROR_NONE)
        {
          ret = 0;
        }
    ...
    case SC_PRESSURE:
      for (i = 0; i < Msg->Data[5]; i++)
      {
        if (IKS5A1_ENV_SENSOR_Write_Register(PrsInstance, Msg->Data[6U + (2U * i)],
                                             Msg->Data[7U + (2U * i)]) != BSP_ERROR_NONE)
        {
          ret = 0;
        }
...
static int32_t SC_Read_Multi_Register(Msg_t *Msg)
{
  ...
  switch (Msg->Data[4])
  {
    case SC_ACCELEROMETER:
      for (i = 0; i < Msg->Data[5]; i++)
      {
        if (IKS5A1_MOTION_SENSOR_Read_Register(AccInstance, Msg->Data[6U + (2U * i)],
                                               &(Msg->Data[7U + (2U * i)])) != BSP_ERROR_NONE)
        {
          ret = 0;
        }
    ...
    case SC_GYROSCOPE:
      for (i = 0; i < Msg->Data[5]; i++)
      {
        if (IKS5A1_MOTION_SENSOR_Read_Register(GyrInstance, Msg->Data[6U + (2U * i)],
                                               &(Msg->Data[7U + (2U * i)])) != BSP_ERROR_NONE)
        {
          ret = 0;
        }
    ...
    case SC_MAGNETOMETER:
      for (i = 0; i < Msg->Data[5]; i++)
      {
        if (IKS5A1_MOTION_SENSOR_Read_Register(MagInstance, Msg->Data[6U + (2U * i)],
                                               &(Msg->Data[7U + (2U * i)])) != BSP_ERROR_NONE)
        {
          ret = 0;
        }
    ...
    case SC_TEMPERATURE:
      for (i = 0; i < Msg->Data[5]; i++)
      {
        if (IKS5A1_ENV_SENSOR_Read_Register(TmpInstance, Msg->Data[6U + (2U * i)],
                                            &(Msg->Data[7U + (2U * i)])) != BSP_ERROR_NONE)
        {
          ret = 0;
        }
    ...
    case SC_HUMIDITY:
      for (i = 0; i < Msg->Data[5]; i++)
      {
        if (IKS5A1_ENV_SENSOR_Read_Register(HumInstance, Msg->Data[6U + (2U * i)],
                                            &(Msg->Data[7U + (2U * i)])) != BSP_ERROR_NONE)
        {
          ret = 0;
        }
    ...
    case SC_PRESSURE:
      for (i = 0; i < Msg->Data[5]; i++)
      {
        if (IKS5A1_ENV_SENSOR_Read_Register(PrsInstance, Msg->Data[6U + (2U * i)],
                                            &(Msg->Data[7U + (2U * i)])) != BSP_ERROR_NONE)
        {
          ret = 0;
        }
...
static int32_t SC_Read_Modify_Write_Register(Msg_t *Msg)
{
  ...
  switch (Msg->Data[4])
  {
    case SC_ACCELEROMETER:
      ...
      if (IKS5A1_MOTION_SENSOR_Write_Register(AccInstance, Msg->Data[5], reg_value) != BSP_ERROR_NONE)
      {
        ret = 0;
      }
      break;
    ...
    case SC_GYROSCOPE:
      ...
      reg_value = reg_value & Msg->Data[6];
      reg_value = reg_value | Msg->Data[7];
      if (IKS5A1_MOTION_SENSOR_Write_Register(GyrInstance, Msg->Data[5], reg_value) != BSP_ERROR_NONE)
      {
        ret = 0;
      }
      break;
    ...
    case SC_MAGNETOMETER:
      ...
      reg_value = reg_value & Msg->Data[6];
      reg_value = reg_value | Msg->Data[7];
      if (IKS5A1_MOTION_SENSOR_Write_Register(MagInstance, Msg->Data[5], reg_value) != BSP_ERROR_NONE)
      {
        ret = 0;
      }
      break;
    ...
    case SC_TEMPERATURE:
      ...
      reg_value = reg_value & Msg->Data[6];
      reg_value = reg_value | Msg->Data[7];
      if (IKS5A1_ENV_SENSOR_Write_Register(TmpInstance, Msg->Data[5], reg_value) != BSP_ERROR_NONE)
      {
        ret = 0;
      }
      break;
    ...
    case SC_HUMIDITY:
      ...
      reg_value = reg_value & Msg->Data[6];
      reg_value = reg_value | Msg->Data[7];
      if (IKS5A1_ENV_SENSOR_Write_Register(HumInstance, Msg->Data[5], reg_value) != BSP_ERROR_NONE)
      {
        ret = 0;
      }
      break;
    ...
    case SC_PRESSURE:
      ...
      reg_value = reg_value & Msg->Data[6];
      reg_value = reg_value | Msg->Data[7];
      if (IKS5A1_ENV_SENSOR_Write_Register(PrsInstance, Msg->Data[5], reg_value) != BSP_ERROR_NONE)
      {
        ret = 0;
      }
      break;
...
static void DIL24_INT1_Init(void)
{
  ...
  HAL_NVIC_SetPriority(EXTI9_IRQn, 0x0F, 0x00);
...
/**
  * @brief  Concatenate all sensor names of same kind to one string (comma separated)
  * @param  NamesString the pointer to the resulting all sensor names string
  * @param  NamesList the pointer to the list of all sensor names
  * @param  NamesCount all sensor names count
  * @retval None
  */
static void JoinNames(uint8_t NamesString[], uint8_t NamesList[][SENSOR_NAME_MAX_LENGTH], uint8_t NamesCount)
{
  ...
  (void)strcat((char *)NamesString, (char *)NamesList[0]);
  for (int i = 1; i < NamesCount; i++)
  {
    (void)strcat((char *)NamesString, ",");
    (void)strcat((char *)NamesString, (char *)NamesList[i]);
  }
}
