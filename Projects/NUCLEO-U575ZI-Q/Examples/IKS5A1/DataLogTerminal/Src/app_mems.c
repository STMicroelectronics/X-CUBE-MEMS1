...
static IKS5A1_MOTION_SENSOR_Capabilities_t MotionCapabilities[IKS5A1_MOTION_INSTANCES_NBR];
static IKS5A1_ENV_SENSOR_Capabilities_t EnvCapabilities[IKS5A1_ENV_INSTANCES_NBR];
...
static void MX_IKS5A1_DataLogTerminal_Init(void);
static void MX_IKS5A1_DataLogTerminal_Process(void);
...
void MX_MEMS_Init(void)
{
  ...
  MX_IKS5A1_DataLogTerminal_Init();
...
void MX_MEMS_Process(void)
{
  ...
  MX_IKS5A1_DataLogTerminal_Process();
...
/**
  ...
  * @retval None
  */
void MX_IKS5A1_DataLogTerminal_Init(void)
{
  ...
  IKS5A1_MOTION_SENSOR_Init(IKS5A1_ISM330IS_0, MOTION_ACCELERO | MOTION_GYRO);

  IKS5A1_MOTION_SENSOR_Init(IKS5A1_ISM6HG256X_0, MOTION_ACCELERO | MOTION_GYRO);

  IKS5A1_MOTION_SENSOR_Init(IKS5A1_IIS2DULPX_0, MOTION_ACCELERO);

  IKS5A1_MOTION_SENSOR_Init(IKS5A1_IIS2MDC_0, MOTION_MAGNETO);

  for (i = 0; i < IKS5A1_MOTION_INSTANCES_NBR; i++)
  {
    IKS5A1_MOTION_SENSOR_GetCapabilities(i, &MotionCapabilities[i]);
    snprintf(dataOut, MAX_BUF_SIZE,
  ...
  IKS5A1_ENV_SENSOR_Init(IKS5A1_ILPS22QS_0, ENV_PRESSURE);

  for (i = 0; i < IKS5A1_ENV_INSTANCES_NBR; i++)
  {
    IKS5A1_ENV_SENSOR_GetCapabilities(i, &EnvCapabilities[i]);
    snprintf(dataOut, MAX_BUF_SIZE,
...
/**
  ...
  * @retval None
  */
void MX_IKS5A1_DataLogTerminal_Process(void)
{
  int32_t i;
...
static void Accelero_Sensor_Handler(uint32_t Instance)
{
  ...
  if (IKS5A1_MOTION_SENSOR_GetAxes(Instance, MOTION_ACCELERO, &acceleration))
  {
    snprintf(dataOut, MAX_BUF_SIZE, "\r\nACC[%d]: Error\r\n", (int)Instance);
  }
  else
  ...
  if (verbose == 1)
  {
    if (IKS5A1_MOTION_SENSOR_ReadID(Instance, &whoami))
    {
    ...
    if (IKS5A1_MOTION_SENSOR_GetOutputDataRate(Instance, MOTION_ACCELERO, &odr))
    {
    ...
    if (IKS5A1_MOTION_SENSOR_GetFullScale(Instance, MOTION_ACCELERO, &fullScale))
    {
...
static void Gyro_Sensor_Handler(uint32_t Instance)
{
  ...
  if (IKS5A1_MOTION_SENSOR_GetAxes(Instance, MOTION_GYRO, &angular_velocity))
  {
    snprintf(dataOut, MAX_BUF_SIZE, "\r\nGYR[%d]: Error\r\n", (int)Instance);
  }
  else
  ...
  if (verbose == 1)
  {
    ...
    if (IKS5A1_MOTION_SENSOR_GetOutputDataRate(Instance, MOTION_GYRO, &odr))
    {
      snprintf(dataOut, MAX_BUF_SIZE, "ODR[%d]: ERROR\r\n", (int)Instance);
    }
    else
    ...
    if (IKS5A1_MOTION_SENSOR_GetFullScale(Instance, MOTION_GYRO, &fullScale))
    {
      snprintf(dataOut, MAX_BUF_SIZE, "FS[%d]: ERROR\r\n", (int)Instance);
    }
    else
...
static void Magneto_Sensor_Handler(uint32_t Instance)
{
  ...
  if (IKS5A1_MOTION_SENSOR_GetAxes(Instance, MOTION_MAGNETO, &magnetic_field))
  {
    snprintf(dataOut, MAX_BUF_SIZE, "\r\nMAG[%d]: Error\r\n", (int)Instance);
  }
  else
  ...
  if (verbose == 1)
  {
    ...
    if (IKS5A1_MOTION_SENSOR_GetOutputDataRate(Instance, MOTION_MAGNETO, &odr))
    {
      snprintf(dataOut, MAX_BUF_SIZE, "ODR[%d]: ERROR\r\n", (int)Instance);
    }
    else
    ...
    if (IKS5A1_MOTION_SENSOR_GetFullScale(Instance, MOTION_MAGNETO, &fullScale))
    {
      snprintf(dataOut, MAX_BUF_SIZE, "FS[%d]: ERROR\r\n", (int)Instance);
    }
    else
...
static void Press_Sensor_Handler(uint32_t Instance)
{
  ...
  if (IKS5A1_ENV_SENSOR_GetValue(Instance, ENV_PRESSURE, &pressure))
  {
    snprintf(dataOut, MAX_BUF_SIZE, "\r\nPress[%d]: Error\r\n", (int)Instance);
  }
  else
  ...
  if (verbose == 1)
  {
    if (IKS5A1_ENV_SENSOR_ReadID(Instance, &whoami))
    {
      snprintf(dataOut, MAX_BUF_SIZE, "WHOAMI[%d]: Error\r\n", (int)Instance);
    }
    else
    ...
    if (IKS5A1_ENV_SENSOR_GetOutputDataRate(Instance, ENV_PRESSURE, &odr))
    {
      snprintf(dataOut, MAX_BUF_SIZE, "ODR[%d]: Error\r\n", (int)Instance);
    }
    else
