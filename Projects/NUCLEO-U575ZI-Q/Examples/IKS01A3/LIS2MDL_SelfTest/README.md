...
## <b>LIS2MDL_SelfTest Example Description</b>

This example shows how to use sensor expansion board to test the mode of operation of the magnetometer and send the results from a Nucleo board using UART to a connected PC or Desktop and display them on generic applications like TeraTerm.
