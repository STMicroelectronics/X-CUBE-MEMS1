...
## <b>LPS22HB_FIFOMode Example Description</b>

This example shows how to use sensor expansion board to store LPS22HB data into a FIFO, get these data from the FIFO and send them from a Nucleo board using UART to a connected PC or Desktop and display them on generic applications like TeraTerm.
