...
## <b>LSM6DSL_FIFOLowPower Example Description</b>

This example shows how to use sensor expansion board to store accelerometer data into a FIFO and send the stored data from a Nucleo board using UART to a connected PC or Desktop and display them on generic applications like TeraTerm.
After connection has been established:

  - the user can push the user button to launch the FIFO Low Power Demo and then view the results using an hyper terminal; after that, the component goes to sleep mode
