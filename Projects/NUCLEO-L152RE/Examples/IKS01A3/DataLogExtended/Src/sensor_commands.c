...
static uint32_t GyrFsList[][7] =        /* dps */
{
  ...
  {6, 125, 250, 500, 1000, 2000, 4000}, /* LSM6DSV16 */
  ...
  switch (Msg->Data[4])
  {
    case SC_ACCELEROMETER:
      if (IsHybridAccSensor == HYBRID_SENSOR && AccInstance == IKS01A3_LIS2DTW12_0)
      {
        ...
        if (IKS01A3_HYBRID_SENSOR_Write_Register(AccInstance, Msg->Data[5], reg_value) != BSP_ERROR_NONE)
        {
          ret = 0;
        }
      }
    ...
    case SC_GYROSCOPE:
      ...
      reg_value = reg_value & Msg->Data[6];
      reg_value = reg_value | Msg->Data[7];
      if (IKS01A3_MOTION_SENSOR_Write_Register(GyrInstance, Msg->Data[5], reg_value) != BSP_ERROR_NONE)
      {
        ret = 0;
      }
      break;
    ...
    case SC_MAGNETOMETER:
      ...
      reg_value = reg_value & Msg->Data[6];
      reg_value = reg_value | Msg->Data[7];
      if (IKS01A3_MOTION_SENSOR_Write_Register(MagInstance, Msg->Data[5], reg_value) != BSP_ERROR_NONE)
      {
        ret = 0;
      }
      break;
    ...
    case SC_TEMPERATURE:
      if (IsHybridTmpSensor == HYBRID_SENSOR && TmpInstance == IKS01A3_LIS2DTW12_0)
      {
        ...
        reg_value = reg_value & Msg->Data[6];
        reg_value = reg_value | Msg->Data[7];
        if (IKS01A3_HYBRID_SENSOR_Write_Register(TmpInstance, Msg->Data[5], reg_value) != BSP_ERROR_NONE)
        {
          ret = 0;
        }
      }
      else
      {
        ...
        reg_value = reg_value & Msg->Data[6];
        reg_value = reg_value | Msg->Data[7];
        if (IKS01A3_ENV_SENSOR_Write_Register(TmpInstance, Msg->Data[5], reg_value) != BSP_ERROR_NONE)
        {
          ret = 0;
        }
      }
    ...
    case SC_HUMIDITY:
      ...
      reg_value = reg_value & Msg->Data[6];
      reg_value = reg_value | Msg->Data[7];
      if (IKS01A3_ENV_SENSOR_Write_Register(HumInstance, Msg->Data[5], reg_value) != BSP_ERROR_NONE)
      {
        ret = 0;
      }
      break;
