...
## <b>ECompass Application Description</b>

This application shows how to use [MotionEC - E-Compass](https://www.st.com/resource/en/user_manual/um2225-getting-started-with-motionec-realtime-ecompass-library-in-xcubemems1-expansion-for-stm32cube-stmicroelectronics.pdf) library to estimate current device attitude by using accelerometer and magnetometer.
...
After connection has been established:
  ...
  - the user can view device attitude data or visualize them using compass model
