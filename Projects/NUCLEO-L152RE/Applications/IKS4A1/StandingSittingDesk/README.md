...
## <b>StandingSittingDesk Application Description</b>

This application shows how to use [MotionSD - Standing versus Sitting Desk Detection](https://www.st.com/resource/en/user_manual/um2276-getting-started-with-motionsd-standing-vs-sitting-desk-detection-library-in-xcubemems1-expansion-for-stm32cube-stmicroelectronics.pdf) library to distinguish user working mode - sitting at the desk or standing desk position usign accelerometer and pressure sensor.
...
After connection has been established:
  ...
  - the user can view standing versus sitting desk data
