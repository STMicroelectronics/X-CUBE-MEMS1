...
## <b>FallDetection Application Description</b>

This application shows how to use [MotionFD - Fall Detection](https://www.st.com/resource/en/user_manual/um2275-getting-started-with-motionfd-realtime-fall-detection-library-in-xcubemems1-expansion-for-stm32cube-stmicroelectronics.pdf) library to detect fall event by using accelerometer and pressure sensor.
...
After connection has been established:
  ...
  - the user can view fall detection data
