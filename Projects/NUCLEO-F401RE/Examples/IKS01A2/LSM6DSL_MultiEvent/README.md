...
## <b>LSM6DSL_MultiEvent Example Description</b>

This example shows how to use sensor expansion board to detect free fall, tap, double tap, tilt, wake up, 6D Orientation and step events through the LSM6DSL sensor and send data from a Nucleo board using UART to a connected PC or Desktop and display it on generic applications like TeraTerm.
