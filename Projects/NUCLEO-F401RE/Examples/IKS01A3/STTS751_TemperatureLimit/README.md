...
## <b>STTS751_TemperatureLimit Example Description</b>

This example shows how to use sensor expansion board to measure temperature, detect exceeding of temperature limits and send data from a Nucleo board using UART to a connected PC or Desktop and display it on generic applications like TeraTerm.
