...
## <b>LSM6DSO_FIFOContinuousMode Example Description</b>

This example shows how to use sensor expansion board to store gyroscope data into a FIFO in continuous mode and send the stored data from a Nucleo board using UART to a connected PC or Desktop and display them on generic applications like TeraTerm.
After connection has been established:
  ...
  - the user can push the user button again to pass from FIFO in continuous mode to FIFO in bypass mode
  - the user can push the user button again to restart the FIFO demo in continuous mode and so on
