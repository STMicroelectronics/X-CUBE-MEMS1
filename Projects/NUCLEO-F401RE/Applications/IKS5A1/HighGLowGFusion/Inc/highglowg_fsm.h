...
#define HIGHGLOWG_FSM_THRESH1_LSB_INDEX 30U
#define HIGHGLOWG_FSM_THRESH1_MSB_INDEX 31U
#define HIGHGLOWG_FSM_THRESH2_LSB_INDEX 32U
#define HIGHGLOWG_FSM_THRESH2_MSB_INDEX 33U
...
static const ucf_line_ext_t highglowg_fsm[] =
{
	...
	{ .op = MEMS_UCF_OP_WRITE, .address = 0x4E, .data = 0x00 },
	...
	{ .op = MEMS_UCF_OP_WRITE, .address = 0x5F, .data = 0x4B },
	{ .op = MEMS_UCF_OP_WRITE, .address = 0x46, .data = 0x01 },
	...
	{ .op = MEMS_UCF_OP_WRITE, .address = 0x09, .data = 0xB5 },
	...
	{ .op = MEMS_UCF_OP_WRITE, .address = 0x63, .data = 0x70 },
	{ .op = MEMS_UCF_OP_WRITE, .address = 0x10, .data = 0x04 }
};
