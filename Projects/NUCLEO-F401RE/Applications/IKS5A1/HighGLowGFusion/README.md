...
## <b>HighGLowGFusion Application Description</b>

This application shows how to use [MotionXLF - High-g Low-g Fusion](https://www.st.com/resource/en/user_manual/um3509-getting-started-with-motionxlf-highg-lowg-fusion-library-in-xcubemems1-expansion-for-stm32cube-stmicroelectronics.pdf) library to fuse the accelerometer sensor data using high-g sensor only.
...
### <b>Hardware and Software environment</b>
  ...
  - This example runs on STM32 Nucleo devices with MEMS sensor expansion board (X-NUCLEO-IKS5A1)
