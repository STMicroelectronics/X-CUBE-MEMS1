...
This application shows how to use [MotionAW - Activity Recognition for Wrist](https://www.st.com/resource/en/user_manual/um2194-getting-started-with-motionaw-activity-recognition-for-wrist-library-in-xcubemems1-expansion-for-stm32cube-stmicroelectronics.pdf) library to detect activity performed by user using accelerometer only.
