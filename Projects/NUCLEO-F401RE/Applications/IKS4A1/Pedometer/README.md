...
## <b>Pedometer Application Description</b>

This application shows how to use [MotionPM - Pedometer](https://www.st.com/resource/en/user_manual/um2207-getting-started-with-motionpm-realtime-pedometer-library-in-xcubemems1-expansion-for-stm32cube-stmicroelectronics.pdf) library to get the cadence and number of steps by using accelerometer only.
