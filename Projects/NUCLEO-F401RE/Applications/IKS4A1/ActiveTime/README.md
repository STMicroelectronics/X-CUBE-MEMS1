...
This application shows how to use [MotionAT - Active Time](https://www.st.com/resource/en/user_manual/um2349-getting-started-with-motionat-active-time-library-in-xcubemems1-expansion-for-stm32cube-stmicroelectronics.pdf) library to get the number of active seconds using accelerometer only.
