...
## <b>HighGLowGFusion_LSM6DSV320X Application Description</b>

This application shows how to use [MotionXLF - High-g Low-g Fusion](https://www.st.com/resource/en/user_manual/um3509-getting-started-with-motionxlf-highg-lowg-fusion-library-in-xcubemems1-expansion-for-stm32cube-stmicroelectronics.pdf) library to fuse the accelerometer sensor data using high-g sensors such as LSM6DSV320X only.
...
After connection has been established:
  ...
  - the user can view both low and high-g data from the selected high-g Accelerometer
  - the user can perform the accelerometer high and low-g fusion
  - the user can view fused low-g and high-g accelerometer data
...
ADDITIONAL_BOARD : STEVAL-MKI251A https://www.st.com/en/evaluation-tools/steval-mki251a.html
ADDITIONAL_COMP : LSM6DSV320X https://www.st.com/en/mems-and-sensors/lsm6dsv320x.html
