...
This application shows how to use [MotionAC - Accelerometer Calibration](https://www.st.com/resource/en/user_manual/um2182-getting-started-with-motionac-accelerometer-calibration-library-in-xcubemems1-expansion-for-stm32cube-stmicroelectronics.pdf) library to correct accelerometer sensor data using accelerometer only.
