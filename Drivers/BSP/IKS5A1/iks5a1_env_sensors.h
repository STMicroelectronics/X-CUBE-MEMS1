...
#ifndef IKS5A1_ENV_SENSORS_H
#define IKS5A1_ENV_SENSORS_H
...
#ifndef USE_IKS5A1_ENV_SENSOR_ILPS22QS_0
#define USE_IKS5A1_ENV_SENSOR_ILPS22QS_0   1U
#endif

#ifndef USE_IKS5A1_ENV_SENSOR_SHT40AD1B_0
#define USE_IKS5A1_ENV_SENSOR_SHT40AD1B_0  0U
#endif
...
/** @addtogroup IKS5A1_ENV_SENSORS IKS5A1 ENV SENSORS
  * @{
  */

/** @defgroup IKS5A1_ENV_SENSORS_Exported_Types IKS5A1 ENV SENSORS Exported Types
  * @{
  */
...
typedef struct
{
  ...
  float   PressMaxOdr;
  float   GasMaxOdr;
} IKS5A1_ENV_SENSOR_Capabilities_t;

typedef struct
{
  uint32_t Functions;
} IKS5A1_ENV_SENSOR_Ctx_t;

/**
  * @}
  */

/** @defgroup IKS5A1_ENV_SENSOR_Exported_Constants IKS5A1 ENV SENSOR Exported Constants
  * @{
  */

#if (USE_IKS5A1_ENV_SENSOR_ILPS22QS_0 == 1)
#define IKS5A1_ILPS22QS_0  0
#endif

#if (USE_IKS5A1_ENV_SENSOR_SHT40AD1B_0 == 1)
#define IKS5A1_SHT40AD1B_0  (USE_IKS5A1_ENV_SENSOR_ILPS22QS_0)
#endif
...
#define IKS5A1_ENV_FUNCTIONS_NBR  4U
#define IKS5A1_ENV_INSTANCES_NBR  (USE_IKS5A1_ENV_SENSOR_ILPS22QS_0 + \
                                   USE_IKS5A1_ENV_SENSOR_SHT40AD1B_0)

#if (IKS5A1_ENV_INSTANCES_NBR == 0)
...
/** @addtogroup IKS5A1_ENV_SENSORS_Exported_Functions IKS5A1 ENV SENSOR Exported Functions
  * @{
  */
