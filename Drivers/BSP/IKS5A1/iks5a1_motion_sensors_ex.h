/**
  ******************************************************************************
  * @file    iks5a1_motion_sensors_ex.h
...
#ifndef IKS5A1_MOTION_SENSOR_EX_H
#define IKS5A1_MOTION_SENSOR_EX_H
...
/** @addtogroup IKS5A1_MOTION_SENSOR_EX IKS5A1 MOTION SENSOR EX
  * @{
  */

/** @defgroup IKS5A1_MOTION_SENSOR_EX_Exported_Types IKS5A1 MOTION SENSOR EX Exported Types
  * @{
  */

typedef enum
{
  IKS5A1_MOTION_SENSOR_INT1_PIN = 0,
  IKS5A1_MOTION_SENSOR_INT2_PIN
} IKS5A1_MOTION_SENSOR_IntPin_t;
...
} IKS5A1_MOTION_SENSOR_Event_Status_t;

/**
  * @}
  */

/** @addtogroup IKS5A1_MOTION_SENSOR_EX_Exported_Functions IKS5A1 MOTION SENSOR EX Exported Functions
  * @{
  */
...
#endif /* IKS5A1_MOTION_SENSOR_EX_H */
