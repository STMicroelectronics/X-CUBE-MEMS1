 ...
 * @brief   LSM6DSV16BX header driver file
 ******************************************************************************
 * @attention
 *
...
#ifndef LSM6DSV16BX_H
#define LSM6DSV16BX_H
...
/** @addtogroup LSM6DSV16BX LSM6DSV16BX
 * @{
 */

/** @defgroup LSM6DSV16BX_Exported_Types LSM6DSV16BX Exported Types
 * @{
 */

typedef int32_t (*LSM6DSV16BX_Init_Func)(void);
typedef int32_t (*LSM6DSV16BX_DeInit_Func)(void);
typedef int32_t (*LSM6DSV16BX_GetTick_Func)(void);
typedef void    (*LSM6DSV16BX_Delay_Func)(uint32_t);
typedef int32_t (*LSM6DSV16BX_WriteReg_Func)(uint16_t, uint16_t, uint8_t *, uint16_t);
typedef int32_t (*LSM6DSV16BX_ReadReg_Func)(uint16_t, uint16_t, uint8_t *, uint16_t);
...
typedef enum
{
  ...
  LSM6DSV16BX_ACC_HIGH_ACCURACY_MODE,
  LSM6DSV16BX_ACC_NORMAL_MODE,
...
typedef enum
{
  ...
  LSM6DSV16BX_GYRO_HIGH_ACCURACY_MODE,
...
typedef struct
{
  LSM6DSV16BX_Init_Func       Init;
  LSM6DSV16BX_DeInit_Func     DeInit;
  uint32_t                    BusType; /*0 means I2C, 1 means SPI 4-Wires, 2 means SPI-3-Wires, 3 means I3C */
  uint8_t                     Address;
  LSM6DSV16BX_WriteReg_Func   WriteReg;
  LSM6DSV16BX_ReadReg_Func    ReadReg;
  LSM6DSV16BX_GetTick_Func    GetTick;
  LSM6DSV16BX_Delay_Func      Delay;
} LSM6DSV16BX_IO_t;
...
typedef struct
{
  ...
  float     AccMaxOdr;
  float     MagMaxOdr;
} LSM6DSV16BX_Capabilities_t;

typedef struct
{
  int32_t (*Init)(LSM6DSV16BX_Object_t *);
  int32_t (*DeInit)(LSM6DSV16BX_Object_t *);
  int32_t (*ReadID)(LSM6DSV16BX_Object_t *, uint8_t *);
  int32_t (*GetCapabilities)(LSM6DSV16BX_Object_t *, LSM6DSV16BX_Capabilities_t *);
} LSM6DSV16BX_CommonDrv_t;

typedef struct
{
  int32_t (*Enable)(LSM6DSV16BX_Object_t *);
  int32_t (*Disable)(LSM6DSV16BX_Object_t *);
  int32_t (*GetSensitivity)(LSM6DSV16BX_Object_t *, float *);
  int32_t (*GetOutputDataRate)(LSM6DSV16BX_Object_t *, float *);
  int32_t (*SetOutputDataRate)(LSM6DSV16BX_Object_t *, float);
  int32_t (*GetFullScale)(LSM6DSV16BX_Object_t *, int32_t *);
  int32_t (*SetFullScale)(LSM6DSV16BX_Object_t *, int32_t);
  int32_t (*GetAxes)(LSM6DSV16BX_Object_t *, LSM6DSV16BX_Axes_t *);
  int32_t (*GetAxesRaw)(LSM6DSV16BX_Object_t *, LSM6DSV16BX_AxesRaw_t *);
} LSM6DSV16BX_ACC_Drv_t;
...
/** @defgroup LSM6DSV16BX_Exported_Constants LSM6DSV16BX Exported Constants
 * @{
 */

#define LSM6DSV16BX_OK                       0
#define LSM6DSV16BX_ERROR                   -1
...
/** @addtogroup LSM6DSV16BX_Exported_Functions LSM6DSV16BX Exported Functions
 * @{
 */
...
int32_t LSM6DSV16BX_Set_Mem_Bank(LSM6DSV16BX_Object_t *pObj, uint8_t Val);

/**
 * @}
 */

/** @addtogroup LSM6DSV16BX_Exported_Variables LSM6DSV16BX Exported Variables
 * @{
 */

extern LSM6DSV16BX_CommonDrv_t LSM6DSV16BX_COMMON_Driver;
extern LSM6DSV16BX_ACC_Drv_t LSM6DSV16BX_ACC_Driver;
extern LSM6DSV16BX_GYRO_Drv_t LSM6DSV16BX_GYRO_Driver;
...
typedef enum {
  LSM6DSV16BX_ULTRA_LIGHT  = 0,
  LSM6DSV16BX_VERY_LIGHT   = 1,
  LSM6DSV16BX_LIGHT        = 2,
  LSM6DSV16BX_MEDIUM       = 3,
  LSM6DSV16BX_STRONG       = 4,
  LSM6DSV16BX_VERY_STRONG  = 5,
  LSM6DSV16BX_AGGRESSIVE   = 6,
  LSM6DSV16BX_XTREME       = 7,
} lsm6dsv16bx_ftype_t;

typedef enum {
  LSM6DSV16BX_HP_FILTER_NONE     = 0x00,
  LSM6DSV16BX_HP_FILTER_16mHz    = 0x80,
  LSM6DSV16BX_HP_FILTER_65mHz    = 0x81,
  LSM6DSV16BX_HP_FILTER_260mHz   = 0x82,
  LSM6DSV16BX_HP_FILTER_1Hz04    = 0x83,
} lsm6dsv16bx_hpm_g_t;

typedef enum {
  LSM6DSV16BX_HP_PATH_DISABLE_ON_OUT    = 0x00,
  LSM6DSV16BX_SLOPE_ODR_DIV_4           = LSM6DSV16BX_GY_ULTRA_LIGHT,
  LSM6DSV16BX_HP_ODR_DIV_10             = LSM6DSV16BX_GY_VERY_LIGHT,
  LSM6DSV16BX_HP_ODR_DIV_20             = LSM6DSV16BX_GY_LIGHT,
  LSM6DSV16BX_HP_ODR_DIV_45             = LSM6DSV16BX_GY_MEDIUM,
  LSM6DSV16BX_HP_ODR_DIV_100            = LSM6DSV16BX_GY_STRONG,
  LSM6DSV16BX_HP_ODR_DIV_200            = LSM6DSV16BX_GY_VERY_STRONG,
  LSM6DSV16BX_HP_ODR_DIV_400            = LSM6DSV16BX_GY_AGGRESSIVE,
  LSM6DSV16BX_HP_ODR_DIV_800            = LSM6DSV16BX_GY_XTREME,

  LSM6DSV16BX_HP_REF_MD_ODR_DIV_10      = 0x31,
  LSM6DSV16BX_HP_REF_MD_ODR_DIV_20      = 0x32,
  LSM6DSV16BX_HP_REF_MD_ODR_DIV_45      = 0x33,
  LSM6DSV16BX_HP_REF_MD_ODR_DIV_100     = 0x34,
  LSM6DSV16BX_HP_REF_MD_ODR_DIV_200     = 0x35,
  LSM6DSV16BX_HP_REF_MD_ODR_DIV_400     = 0x36,
  LSM6DSV16BX_HP_REF_MD_ODR_DIV_800     = 0x37,
  LSM6DSV16BX_LP_ODR_DIV_10             = 0x01,
  LSM6DSV16BX_LP_ODR_DIV_20             = 0x02,
  LSM6DSV16BX_LP_ODR_DIV_45             = 0x03,
  LSM6DSV16BX_LP_ODR_DIV_100            = 0x04,
  LSM6DSV16BX_LP_ODR_DIV_200            = 0x05,
  LSM6DSV16BX_LP_ODR_DIV_400            = 0x06,
  LSM6DSV16BX_LP_ODR_DIV_800            = 0x07,
} lsm6dsv16bx_hp_slope_xl_en_t;
