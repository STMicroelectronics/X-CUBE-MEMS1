...
int32_t lis2dux12_mode_get(stmdev_ctx_t *ctx, lis2dux12_md_t *val)
{
  ...
  switch (ctrl5.odr)
  {
    ...
    case LIS2DUX12_12Hz5:
      val->odr = (ctrl3.hp_en) ? LIS2DUX12_12Hz5_HP : LIS2DUX12_12Hz5;
      break;
    case LIS2DUX12_25Hz:
      val->odr = (ctrl3.hp_en) ? LIS2DUX12_25Hz_HP : LIS2DUX12_25Hz;
      break;
    case LIS2DUX12_50Hz:
      val->odr = (ctrl3.hp_en) ? LIS2DUX12_50Hz_HP : LIS2DUX12_50Hz;
      break;
    case LIS2DUX12_100Hz:
      val->odr = (ctrl3.hp_en) ? LIS2DUX12_100Hz_HP : LIS2DUX12_100Hz;
      break;
    case LIS2DUX12_200Hz:
      val->odr = (ctrl3.hp_en) ? LIS2DUX12_200Hz_HP : LIS2DUX12_200Hz;
      break;
    case LIS2DUX12_400Hz:
      val->odr = (ctrl3.hp_en) ? LIS2DUX12_400Hz_HP : LIS2DUX12_400Hz;
      break;
    case LIS2DUX12_800Hz:
      val->odr = (ctrl3.hp_en) ? LIS2DUX12_800Hz_HP : LIS2DUX12_800Hz;
      break;
...
int32_t lis2dux12_all_sources_get(stmdev_ctx_t *ctx, lis2dux12_all_sources_t *val)
{
  ...
  {
    ret = lis2dux12_read_reg(ctx, LIS2DUX12_ALL_INT_SRC, (uint8_t *)&all_int_src, 1);
...
int32_t lis2dux12_wakeup_config_get(stmdev_ctx_t *ctx, lis2dux12_wakeup_config_t *val)
{
  ...
  if (ret == 0)
  {
    val->wake_dur = (enum lis2dux12_wake_dur)((wup_dur_ext.wu_dur_extended << 2) | wup_dur.wake_dur);
