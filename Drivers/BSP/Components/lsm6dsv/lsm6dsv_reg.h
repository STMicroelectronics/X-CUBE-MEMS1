...
#define LSM6DSV_UI_OIS_SHARED_0    0x65U
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  ...
  uint8_t ui_spi2_shared  : 8;
#endif /* DRV_BYTE_ORDER */
} lsm6dsv_ui_ois_shared_0_t;

#define LSM6DSV_UI_OIS_SHARED_1    0x66U
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  uint8_t ui_spi2_shared  : 8;
  ...
  uint8_t ui_spi2_shared  : 8;
#endif /* DRV_BYTE_ORDER */
} lsm6dsv_ui_ois_shared_1_t;

#define LSM6DSV_UI_OIS_SHARED_2    0x67U
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  uint8_t ui_spi2_shared  : 8;
  ...
  uint8_t ui_spi2_shared  : 8;
#endif /* DRV_BYTE_ORDER */
} lsm6dsv_ui_ois_shared_2_t;

#define LSM6DSV_UI_OIS_SHARED_3    0x68U
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  uint8_t ui_spi2_shared  : 8;
  ...
  uint8_t ui_spi2_shared  : 8;
#endif /* DRV_BYTE_ORDER */
} lsm6dsv_ui_ois_shared_3_t;

#define LSM6DSV_UI_OIS_SHARED_4    0x69U
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  uint8_t ui_spi2_shared  : 8;
  ...
  uint8_t ui_spi2_shared  : 8;
#endif /* DRV_BYTE_ORDER */
} lsm6dsv_ui_ois_shared_4_t;

#define LSM6DSV_UI_OIS_SHARED_5    0x6AU
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  uint8_t ui_spi2_shared  : 8;
...
typedef union
{
  ...
  lsm6dsv_ah_out_l_t    ah_out_l;
  lsm6dsv_ah_out_h_t    ah_out_h;
  ...
  lsm6dsv_ui_ois_shared_0_t    ui_ois_shared_0;
  lsm6dsv_ui_ois_shared_1_t    ui_ois_shared_1;
  lsm6dsv_ui_ois_shared_2_t    ui_ois_shared_2;
  lsm6dsv_ui_ois_shared_3_t    ui_ois_shared_3;
  lsm6dsv_ui_ois_shared_4_t    ui_ois_shared_4;
  lsm6dsv_ui_ois_shared_5_t    ui_ois_shared_5;
...
typedef enum
{
  ...
  LSM6DSV_XL_ODR_AT_1Hz875 = 0x1,
  LSM6DSV_XL_ODR_AT_7Hz5 = 0x2,
  LSM6DSV_XL_ODR_AT_15Hz = 0x3,
  LSM6DSV_XL_ODR_AT_30Hz = 0x4,
  LSM6DSV_XL_ODR_AT_60Hz = 0x5,
  LSM6DSV_XL_ODR_AT_120Hz = 0x6,
  LSM6DSV_XL_ODR_AT_240Hz = 0x7,
  LSM6DSV_XL_ODR_AT_480Hz = 0x8,
  LSM6DSV_XL_ODR_AT_960Hz = 0x9,
  LSM6DSV_XL_ODR_AT_1920Hz = 0xA,
  LSM6DSV_XL_ODR_AT_3840Hz = 0xB,
  LSM6DSV_XL_ODR_AT_7680Hz = 0xC,
} lsm6dsv_xl_data_rate_t;
...
typedef enum
{
  LSM6DSV_GY_ODR_OFF = 0x0,
  LSM6DSV_GY_ODR_AT_7Hz5 = 0x2,
  LSM6DSV_GY_ODR_AT_15Hz = 0x3,
  LSM6DSV_GY_ODR_AT_30Hz = 0x4,
  LSM6DSV_GY_ODR_AT_60Hz = 0x5,
  LSM6DSV_GY_ODR_AT_120Hz = 0x6,
  LSM6DSV_GY_ODR_AT_240Hz = 0x7,
  LSM6DSV_GY_ODR_AT_480Hz = 0x8,
  LSM6DSV_GY_ODR_AT_960Hz = 0x9,
  LSM6DSV_GY_ODR_AT_1920Hz = 0xa,
  LSM6DSV_GY_ODR_AT_3840Hz = 0xb,
  LSM6DSV_GY_ODR_AT_7680Hz = 0xc,
} lsm6dsv_gy_data_rate_t;
...
int32_t lsm6dsv_ois_dual_acceleration_raw_get(stmdev_ctx_t *ctx, int16_t *val);
...
typedef enum
{
  LSM6DSV_EIS_1920Hz = 0x0,
  LSM6DSV_EIS_960Hz = 0x1,
