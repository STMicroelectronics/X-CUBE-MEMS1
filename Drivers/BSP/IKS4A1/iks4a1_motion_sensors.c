...
static int32_t MIS2DU12_0_Probe(uint32_t Functions)
{
  ...
  else
  {
    ...
    MotionCtx[IKS4A1_MIS2DU12_0].Functions = ((uint32_t)cap.Gyro) | ((uint32_t)cap.Acc << 1) | ((uint32_t)cap.Magneto << 2);

    MotionCompObj[IKS4A1_MIS2DU12_0] = &mis2du12_obj_0;
    /* The second cast (void *) is added to bypass Misra R11.3 rule */
    MotionDrv[IKS4A1_MIS2DU12_0] = (MOTION_SENSOR_CommonDrv_t *)(void *)&MIS2DU12_COMMON_Driver;
    ...
    {
      /* The second cast (void *) is added to bypass Misra R11.3 rule */
      MotionFuncDrv[IKS4A1_MIS2DU12_0][FunctionIndex[MOTION_ACCELERO]] = (MOTION_SENSOR_FuncDrv_t *)(
                                                                          void *)&MIS2DU12_ACC_Driver;

      if (MotionDrv[IKS4A1_MIS2DU12_0]->Init(MotionCompObj[IKS4A1_MIS2DU12_0]) != MIS2DU12_OK)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
